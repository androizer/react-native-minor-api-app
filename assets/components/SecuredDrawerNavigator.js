...
import {Icon, Container, Header, Body, Content, Button, Text} from 'native-base';
...
const DrawerCustomContentComponent = (props) => (
    <Container>
        ...
        <View style={{borderColor: 'red', borderWidth: 0, borderTopColor: '#CED0CE', borderTopWidth: 1}}>
            <Button iconLeft transparent onPress={() => onStackReset(props)}>
                <Icon type='SimpleLineIcons' name='logout' style={{color: 'black'}}/>
                <Text style={{fontWeight: 'bold', color: 'black', paddingLeft: 20}}>logout</Text>
            </Button>
        </View>
    </Container>
)
