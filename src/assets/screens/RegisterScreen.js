...
import {
  Header, Left, Icon, Container, Content, Form, Item, InputGroup, Input
} from 'native-base';
          ...
          <Content contentContainerStyle={styles.container}>
            <View style={styles.bodyContent}>
              ...
              <Form>
                ...
                <Item style={styles.inputFields}>
                  <Input placeholder="password" onChangeText={password => this.setState({ password })} value={this.state.password} secureTextEntry />
                ...
                <Item style={styles.inputFields}>
                  <Input placeholder="confirm password" onChangeText={confirmPassword => this.setState({ confirmPassword })} value={this.state.confirmPassword} secureTextEntry />
                  {this.state.password && this.state.confirmPassword && (this.state.password == this.state.confirmPassword) ? <Icon style={{ color: 'green' }} name="checkmark-circle" /> : null}
                  {this.state.password && this.state.confirmPassword && this.state.password !== this.state.confirmPassword ? <Icon style={{ color: 'red' }} name="close-circle" /> : null}
                </Item>
              </Form>
...
/* <TextInput onChangeText={email => this.setState({email})} value={this.state.email} style={styles
    .inputFields} placeholder="Enter email"/>
<TextInput onChangeText={username => this.setState({username})} value={this.state.username} style=
{styles.inputFields} placeholder="Enter username"/>
<TextInput onChangeText={phone => this.setState({phone})} value={this.state.phone}
style={styles.inputFields} placeholder="Enter phone"/>
<TextInput onChangeText={password => this.setState({password})} value={this.state.password}
secureTextEntry={true} style={styles.inputFields} placeholder="Enter password"/>
<TextInput onChangeText={confirmPassword => this.setState({confirmPassword})}
value={this.state.confirmPassword} secureTextEntry={true} style={styles.inputFields}
